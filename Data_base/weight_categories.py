...
class WeightCategoriesAdder:
    ...
    woman_weight_categories = {
        age_categories[0]: [str(x) for x in range(30, 61, 5)] + ['+60'],
        age_categories[1]: [str(x) for x in range(35, 66, 5)] + ['+65'],
        age_categories[2]: [str(x) for x in range(45, 71, 5)] + ['+70', 'open'],
        age_categories[3]: [str(x) for x in range(50, 76, 5)] + ['+75', 'open'],
        age_categories[4]: [str(x) for x in range(50, 66, 5)] + ['73', '80', '+80', 'open'],
        age_categories[5]: [str(x) for x in range(50, 66, 5)] + ['73', '80', '+80', 'open'],
        age_categories[6]: [str(x) for x in range(50, 66, 5)] + ['73', '80', '+80', 'open']
    }

    man_weight_categories = {
        age_categories[0]: [str(x) for x in range(35, 61, 5)] + ['+60'],
        age_categories[1]: [str(x) for x in range(40, 71, 5)] + ['+70'],
        age_categories[2]: [str(x) for x in range(55, 96, 10)] + ['50', '+95', 'open'],
        age_categories[2]: [str(x) for x in range(60, 101, 10)] + ['55', '+100', 'open'],
        age_categories[4]: ['70', '77', '85', '92', '100', '115', '+115', 'open'],
        age_categories[5]: ['70', '77', '85', '92', '100', '115', '+115', 'open'],
        age_categories[6]: ['70', '77', '85', '92', '100', '115', '+115', 'open']
    }
